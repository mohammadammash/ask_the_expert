...
const HomeUserCard = () => {
  ...
  return (
    <TouchableOpacity style={styles.shadow_bg} className="flex-row w-5/6 rounded-xl border-0.5 items-center justify-evenly h-1/5" onPress={() => navigation.navigate(ROUTES.EXPERT_PROFILE)}>
